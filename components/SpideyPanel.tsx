    ...
    return (
        <div className="pointer-events-auto">
            ...
            <div className={`
                ...
                bg-transparent border border-transparent p-4 rounded-xl backdrop-blur-0 shadow-none w-[85vw] sm:w-80 z-50 max-h-[75vh] overflow-y-auto custom-scrollbar origin-bottom
