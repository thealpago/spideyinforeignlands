...
const RESET_POSITION = { x: 0, y: 10, z: 0 } // Çok daha yüksekten başlasın (1'den 10'a çıkardık)
...
// Physics
const FORCES = {
	accelerate: 800, // Gücü bir kez daha artırdık
	reverse: 300,
	brake: 10.0,
	engineBrake: 3.0,
...
// Default wheel side friction stiffness - Daha iyi tutuş için artırıldı
const FRONT_WHEEL_FRICTION = 2.5
const REAR_WHEEL_FRICTION = 2.2
...
export const useVehiclePhysics = (vehicleRef, wheels) => {
	...
	useEffect(() => {
		...
		if (typeof vehicle.setIndexForwardAxis === 'function') {
