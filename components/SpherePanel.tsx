...
export const SpherePanel: React.FC<SpherePanelProps> = ({ config, onChange, buttonClassName, isOpen = false, onToggle }) => {
    ...
    const defaultStyle = `flex items-center gap-2 px-4 py-3 rounded-xl transition-all duration-300 border ${isOpen ? 'bg-white/10 text-white shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'bg-zinc-900/60 border-white/10 text-gray-400 hover:text-white hover:bg-zinc-800'}`;
    ...
    return (
        <div className="pointer-events-auto">
            ...
            <div className={`
                ...
                bg-transparent border border-transparent p-4 rounded-xl backdrop-blur-0 shadow-none w-[85vw] sm:w-72 z-50 max-h-[75vh] overflow-y-auto custom-scrollbar origin-bottom
                    ...
                    <CollapsibleSection title="APPEARANCE" defaultOpen={true}>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-[9px] text-gray-400 font-mono">RAINBOW MODE</span>
                                <input 
                                    type="checkbox"
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-[9px] text-gray-400 font-mono">WIREFRAME</span>
                                <input 
                                    type="checkbox"
