...
const useGameStore = create((set, get) => {
	...
	return {
		...
		terrainType: 'desert', // 'desert' or 'grassland'
		...
		// Camera state
		cameraMode: 'orbit', // 'orbit', 'terrain', 'firstPerson' (extensible for future modes)
		cameraAutoRotate: false,
		terrainCameraEnabled: false, // Terrain camera toggle
		setCameraMode: (mode) => set({ cameraMode: mode }),
		setCameraAutoRotate: (autoRotate) => set({ cameraAutoRotate: autoRotate }),
		toggleTerrainCamera: () => set((state) => ({ terrainCameraEnabled: !state.terrainCameraEnabled })),
