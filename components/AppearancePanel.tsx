    ...
    return (
        <div className="pointer-events-auto">
            ...
            <div className={`
                ...
                bg-zinc-900/90 border border-white/10 p-4 rounded-2xl backdrop-blur-xl shadow-2xl w-[90vw] sm:w-72 z-50 max-h-[60vh] overflow-y-auto custom-scrollbar origin-bottom
